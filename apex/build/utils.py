...
def get_blueprint(git_token: str, vcs_type: str, template_id: int) -> tempfile.TemporaryDirectory:
    """
    Get blueprint from VCS

    :param git_token: token for git
    :param vcs_type: VCS type (Github or Gitlab)
    :param template_id: id of template repository in VCS
    :return: blueprint directory
    """
    temp_dir = tempfile.TemporaryDirectory(prefix="apex")
